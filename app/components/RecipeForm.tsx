...
export default function RecipeForm({ duration, image_url, ingredients, instructions, recipe_name, serving_size, editMode = false, id }: Partial<RecipeFormProps>) {
    ...
    const postRecipe = async () => {
        try {
            ...
            let res = await axios.post('http://ec2-18-234-104-66.compute-1.amazonaws.com/create', toFormData(data))
    ...
    const editRecipe = async () => {
        try {
            ...
            let { data, status } = await axios.put('http://ec2-18-234-104-66.compute-1.amazonaws.com/update', recipeChanges, {
                headers: {
